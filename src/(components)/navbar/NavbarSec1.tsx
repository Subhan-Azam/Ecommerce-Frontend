...
export default function NavbarSec1() {
  return (
    <div className="container mx-auto py-1">
      <div className="text-center flex flex-wrap justify-center md:justify-between items-center min-h-[40px]">
        <p className="text-[14px]">Need help? Call us: (+98) 0234 456 789</p>

        <div className="flex  mt-2 sm:mt-0">
          <div className="flex gap-2 items-center w-[109px] mr-[36px]">
